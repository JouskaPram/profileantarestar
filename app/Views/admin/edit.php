...
<div class="hero min-h-screen bg-base-200">
  <div class="hero-content   ">
    ...
    <form action="/admin/update/<?= $card["id"]; ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
    ...
    <div class="card flex-shrink-0 w-[350px] max-w-7xl shadow-2xl bg-base-100">
      <div class="card-body">
        <div class="form-control">
          ...
          <input type="text" placeholder="nama" id="nama" name="nama" class="input input-primary text-slate-200  input-bordered" value="<?= $card['nama']; ?>" />
        </div>
        <div class="form-control">
          <label class="label" for="jabatan">
            <span class="label-text text-slate-200 text-lg font-semibold">jabatan</span>
          </label>
          <input type="text" placeholder="jabatan" id="jabatan" name="jabatan" class="input input-primary text-slate-200  input-bordered" value="<?= $card["jabatan"]; ?>" />
        ...
        <div class="form-control">
          ...
          <input type="text" placeholder="facebook" id="facebook" name="facebook" class="input  input-primary input-bordered text-slate-200" value="<?= $card["facebook"]; ?>" />
        ...
        <div class="form-control" >
          ...
          <input type="text" placeholder="twitter" id="twitter" name="twitter" class="input input-primary text-slate-200  input-bordered" value="<?= $card["twitter"]; ?>" />
        ...
        <div class="form-control" >
            ...
            <input type="text" placeholder="alamat" id="alamat" name="alamat" class="input input-primary text-slate-200  input-bordered" value="<?= $card["alamat"]; ?>" />
        ...
        <div class="form-control" >
            ...
            <input type="text" placeholder="url" id="slug" name="slug" class="input input-primary  text-slate-200  input-bordered" value="<?= $card["slug"]; ?>" />
